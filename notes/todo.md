...
* Серверные заметки (с разделением на текст, ссылка, телефонный контакт)
...
* При переносе строки на новой остаются возможные пробелы или переводы на новую строку, которые отображаются квдратиками
* При переносе строки по пробелу - пробел переносится на начало следующей строки
* Редактирование списка посетителей комнаты - выгнанные, участники, администраторы, владельцы
